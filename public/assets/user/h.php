      ...
      <div class="container">
        ...
        <ul class="top-updates d-flex align-items-center justify-content-center  justify-content-between list-unstyled m-0 p-0">
          <li class="single-item primary-semibold-font level-10 dark-color text-capitalize d-flex align-items-center gap-1 my-hero-text-size   pe-3">
            <span>
              <img src="{{ asset('assets/user/img/header-icon1.png') }}" alt="" class="img-fluid" style="max-width: 500px;" />
          ...
          <li class="single-item primary-semibold-font level-10 dark-color text-capitalize d-flex align-items-center gap-1 my-hero-text-size px-3  ">
            <span>
              <img src="{{ asset('assets/user/img/header-icon2.png') }}" alt="" class="img-fluid" style="max-width: 500px;" />
            </span> FREE INSPECTION
          </li>
          <li class="single-item primary-semibold-font level-10 dark-color text-capitalize d-flex align-items-center gap-1 my-hero-text-size  px-3 ">
            <span>
              <img src="{{ asset('assets/user/img/header-icon3.png') }}" alt="" class="img-fluid" style="max-width: 500px;" />
            </span> JOB APPROVAL
          </li>
          <li class="single-item primary-semibold-font level-10 dark-color text-capitalize d-flex align-items-center gap-1 my-hero-text-size  px-3 ">
            <span>
              <img src="{{ asset('assets/user/img/header-icon4.png') }}" alt="" class="img-fluid" style="max-width: 500px;" />
            </span> REPAIR & FIX
          </li>
          <li class="single-item primary-semibold-font level-10 dark-color text-capitalize d-flex align-items-center gap-1 my-hero-text-size  px-3 ">
            <span>
              <img src="{{ asset('assets/user/img/header-icon5.png') }}" alt="" class="img-fluid" style="max-width: 500px;" />
            </span> DELIVER BACK
          </li>
          <li class="single-item primary-semibold-font level-10 dark-color text-capitalize d-flex align-items-center gap-1 my-hero-text-size  px-3 ">
        ...
        <div class="d-flex align-items-center justify-content-between flex-lg-row gap-lg-0 gap-3">
          ...
          <figure class="header-logo">
            <a href="index.php" class="d-block">
              <img src="{{ asset('assets/user/img/logo.png') }}" class="logo-here w-100 object-cover" alt="" />
            </a>
          </figure>
          <div class="header-details-wrapper d-lg-flex d-none align-items-center justify-content-end gap-3">
            <a class="contact-icon">
                        ...
                        <ul class="list-unstyled p-0 d-flex flex-column gap-4 mb-0">
                          <li><a href="auto-spa.php" class="d-flex">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon12.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                          ...
                          <li><a href="car-inspection.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon6.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                          ...
                          <li><a href="car-wrapping.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon8.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                          ...
                          <li><a href="ceramic.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon11.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                      ...
                      <div class="col-md-4 borderCol">
                        <ul class="list-unstyled p-0 d-flex flex-column gap-4 mb-0">
                          <li><a href="european-cars.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon3.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                          ...
                          <li><a href="german-cars.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon10.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                          ...
                          <li><a href="electric-repair.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon5.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                          ...
                          <li><a href="extended-warranty.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon2.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                      ...
                      <div class="col-md-4 borderCol">
                        <ul class="list-unstyled p-0 d-flex flex-column gap-4 mb-0">
                          <li><a href="general-repair.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon1.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                          ...
                          <li><a href="major-minor-service.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon9.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                          ...
                          <li><a href="road-side-assistance.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon7.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
                          ...
                          <li><a href="tinting.php" class="d-flex gap-2">
                              <span class="menu-icon">
                                <img src="{{ asset('assets/user/img/menu-icon4.png') }}" alt="" class="img-fluid">
                              </span>
                              <div class="menu-text">
