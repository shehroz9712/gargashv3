<head>
    ...
    <meta charset="UTF-8">
    @yield('meta')
    <meta name="author" content="Fusion Folios">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/favicon.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/favicon-16x16.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/favicon-32x32.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/apple-icon-57x57.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/apple-icon-60x60.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/apple-icon-72x72.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/apple-icon-76x76.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/favicon-96x96.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/apple-icon-114x-114.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/apple-icon-120x120.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/apple-icon-144x144.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/apple-icon-152x152.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/apple-icon-180x180.png') }}" />
    <link rel="icon" type="image/png" href="{{ asset('assets/user/img/android-icon-192x192.png') }}" />
    <!-- Flag Icons -->
