...
@section('content')
@section('meta')
 <title>Gargash Auto Major & Minor Services Center Dubai UAE</title>
    <meta name="description" content="Gargash Auto Major & Minor Services Center Dubai UAE. we specialize in Car Major Service Dubai to ensure your vehicle performs at its best for years to come. ">
    <meta name="keywords" content="Car Major Service Dubai,Car Minor Service Dubai,Car Major and Minor Solutions Dubai">
@endsection
            ...
            <div class="row align-items-center white">
                <div class="col-md-6">
                    <div class="experiecne-top-content">
                        ...
                        <p class="fs-5 lh-sm text-black">When your vehicle breaks down, rely on our professional car recovery service in Dubai and car recovery service in Sharjah. Our experienced team ensures that your car is safely transported to your preferred destination or repair shop with minimal stress. Whether you're stranded in the heart of the city or on the outskirts, our fast and reliable service ensures you're never left waiting long.
                      We also offer tailored car recovery solutions in Dubai for all types of vehicles, ensuring your luxury German cars or any other model are handled with the utmost care during the recovery process.
                        </p>
        ...
        <div class="row h-100">
            ...
            <div class="col-md-6 d-flex flex-column justify-content-center gap-3">
                <span class="d-flex flex-column gap-2">
                    <p class="fs-5 fw-semibold m-0 text-start">Efficient Car Recovery Services in Dubai and Sharjah</p>
