        ...
        <div class="row align-items-center white">
            <div class="col-md-5">
                <div class="experiecne-top-content">
                    <h1 class="display-3 fw-bold" style="font-size:45px;">
                            {{ $brand->name }}  
                        </h1>
                    <p class="fs-6 lh-sm ">{{ $brand->heading }}
                    </p>
...
<section class="container">
    <div class="row d-flex align-items-center {{ $index % 2 == 1 ? 'flex-md-row-reverse' : '' }}">
        <div class="col-md-6">
            <img class="img-fluid rounded-3" src="{{ asset('assets/uploads/brands/' . $section->image) }}" alt="hero" />
        </div>
...
<section class="container">
    <div>
        <h2 class="fs-1 fw-bold text-center"> <span style="color: #E6B110;"> Premium Periodic Car </span>Maintenance Service in Dubai</h2>
        <p class="fs-6 fw-semibold text-black-50 text-center">When you bring your luxury vehicle to our state-of-the-art service center, we begin with a comprehensive diagnostic check to assess your car’s condition. Our certified technicians prepare a detailed inspection report highlighting any issues. Before
            any repairs or part replacements are carried out, we consult with you directly—ensuring complete transparency and no surprises. Your car gets the expert care it deserves, and you stay fully informed every step of the way.</p>
    </div>
