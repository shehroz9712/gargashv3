...
<section class="review-section section overflow-hidden">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-7">
          <div class="review-main bg-img-cover img-no-repeat w-100 position-center position-relative">
            <!-- Google Review Image -->
            <div class="google-review position-absolute left-0" style="bottom: 0;">
              <figure>
                <img src="{{ asset('assets/user/img/google-review-img.png') }}" alt="" class="img-fluid">
              </figure>
            </div>
  
            <div class="row align-items-end" style="margin-top:5rem;">
                  ...
                  <a href="#" id="main-review-link" target="_blank">
                    ...
                    <div class="review-commas position-absolute left-0 right-0 mx-auto">
                      <figure class="w-fit mx-auto">
                        <img src="{{ asset('assets/user/img/review-commas.png') }}" alt="" class="img-fluid">
                      </figure>
                    </div>
                  </a>
                </div>
        ...
        <div class="col-lg-4">
          <h3 class="fs-2 fw-bold text-center text-warning">Testimonials</h3>
  ...
  <section class="continer">
    <div class="row row-cols-lg-4 row-cols-md-2 row-cols-1 px-5">
      <div class="">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      const mainReviewRating = document.getElementById("main-review-rating");
      const mainReviewLink = document.getElementById("main-review-link");
      const mainReviewSection = document.getElementById("main-review");
      ...
      reviewLinks.forEach((link) => {
        link.addEventListener("click", function(e) {
          ...
          mainReviewSection.style.opacity = 0;
