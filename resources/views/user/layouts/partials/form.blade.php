<form action="{{ route('user.service-request') }}" method="POST" class="form-wrap form-validate" id="serviceRequestForm">
    <div class="form-bg from-wrapper radius-33 bg-img-cover img-img-no-repeat w-100 position-center">
        <div class="mb-3 form-group ">
            ...
            <input type="text" class="form-control" placeholder="Name" title="Name is required" name="user-name"
        ...
        <div class="mb-3 form-group">
            ...
            <input type="text" class="form-control" placeholder="Plate No#" name="Plate-No" minlength="4"
                maxlength="15">
        </div>
        ...
        <div class="mb-3 form-group">
            ...
            <input type="text" class="form-control" placeholder="Location" name="location" minlength="3"
                maxlength="100">
        </div>
    </div>
