    ...
    <div class="container  px-4">
        <div class="row">
            <div class="col-lg-8">
                ...
                <p class="level-7 primary-light-font dark-color ">As a leading Auto Repair Center in Dubai, we take pride
                    in delivering exceptional solutions for all your car needs. With years of experience, we uphold our
                    vision daily, ensuring that quality service is never compromised.</p>
            </div>
            <div class="col-lg-4">
...
<section class="container">
    <div class="px-3 row row-cols-2 row-cols-md-4">
            ...
            <a href="{{ route('user.servicesDetail', ['slug' => 'general-repair']) }}" class="text-black w-100 h-100">
                <div
                    ...
                    <div class=" index-service-img-width-height-responsive gateway-service-img-width-height-responsive">
                        <span
                            class="index-service-img-width-height-responsive gateway-img-width-height-responsive-1  "></span>
                    </div>
        ...
        <div class="card bg-transparent index-hero-right-services-box-animation gateway-height-responsive border-0">
            <a href="{{ route('user.servicesDetail', ['slug' => 'general-repair']) }}" class="text-black w-100 h-100">
                <div
                    ...
                    <div class=" index-service-img-width-height-responsive gateway-service-img-width-height-responsive">
                        <span
                            class="index-service-img-width-height-responsive gateway-img-width-height-responsive-2"></span>
                    </div>
                    <div class="align-items-center card-body d-flex justify-content-center m-0 p-0 py-3">
        ...
        <div class="card bg-transparent index-hero-right-services-box-animation gateway-height-responsive border-0">
            <a href="{{ route('user.servicesDetail', ['slug' => 'tinting']) }}" class="text-black w-100 h-100">
                <div
                    class="align-items-center d-flex flex-column index-hero-right-services-box-height-responsive index-hero-right-services-box-shadow-animation index-hero-right-services-box-bg text-center ">
                    <div class=" index-service-img-width-height-responsive gateway-service-img-width-height-responsive">
                        <span
                            class="index-service-img-width-height-responsive gateway-img-width-height-responsive-3"></span>
                    </div>
                    <div class="align-items-center card-body d-flex justify-content-center m-0 p-0 py-3">
        ...
        <div class="card bg-transparent index-hero-right-services-box-animation gateway-height-responsive border-0">
            <a href="{{ route('user.servicesDetail', ['slug' => 'general-repair']) }}"
                ...
                <div
                    ...
                    <div class=" index-service-img-width-height-responsive gateway-service-img-width-height-responsive">
                        <span
                            class="index-service-img-width-height-responsive gateway-img-width-height-responsive-4"></span>
                    </div>
                    <div class="align-items-center card-body d-flex justify-content-center m-0 p-0 py-3">
        ...
        <div
            ...
            <a href="{{ route('user.servicesDetail', ['slug' => 'tinting']) }}" class="text-black w-100 h-100">
                <div
                    ...
                    <div class=" index-service-img-width-height-responsive gateway-service-img-width-height-responsive">
                        <span
                            class="index-service-img-width-height-responsive gateway-img-width-height-responsive-5"></span>
                    </div>
                    <div class="align-items-center card-body d-flex justify-content-center m-0 p-0 py-3">
        ...
        <div
            ...
            <a href="{{ route('user.shop') }}" class="text-black w-100 h-100">
                <div
                    ...
                    <div class=" index-service-img-width-height-responsive gateway-service-img-width-height-responsive">
                        <span
                            class="index-service-img-width-height-responsive gateway-img-width-height-responsive-6"></span>
                    </div>
                    <div class="align-items-center card-body d-flex justify-content-center m-0 p-0 py-3">
        ...
        <div
            ...
            <a href="{{ route('user.servicesDetail', ['slug' => 'tinting']) }}" class="text-black w-100 h-100">
                <div
                    ...
                    <div class=" index-service-img-width-height-responsive gateway-service-img-width-height-responsive">
                        <span
                            class="index-service-img-width-height-responsive gateway-img-width-height-responsive-7"></span>
                    </div>
                    <div class="align-items-center card-body d-flex justify-content-center m-0 p-0 py-3">
        ...
        <div
            ...
            <a href="{{ route('user.servicesDetail', ['slug' => 'tinting']) }}" class="text-black w-100 h-100">
                <div
                    ...
                    <div class=" index-service-img-width-height-responsive gateway-service-img-width-height-responsive">
                        <span
                            class="index-service-img-width-height-responsive gateway-img-width-height-responsive-8"></span>
                    </div>
                    <div class="align-items-center card-body d-flex justify-content-center m-0 p-0 py-3">
