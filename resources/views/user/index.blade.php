...
@section('meta')
    ...
    <meta name="description"
        content="Gargash Auto Best Luxury Trusted Car Care Services Garage Service in Dubai UAE. We are offering Luxury Car Care services Dubai UAE that go beyond expectations.">
        ...
        <div class="banner-start-here">
            <div class="banner-top-content text-center">
                <h1 class="level-1 heading-font primary-color" style="font-weight:700;">
                    <span class="secondary-color d-block"> Experience Premium Car Care with </span> 20+ Years of
                    Expertise
                </h1>
                ...
                <div class="col-lg-7 my-auto">
                    <div class="d-flex">
                        <div class="bg-white-overlay h-75 position-relative w-100 shadow rounded-2">
                            <div class="d-flex image-container justify-content-evenly mt-5 mt-md-0 p-md-3 px-md-5 row row-cols-3 row-cols-md-5 w-100 "
                                style="row-gap: 3rem; overflow-y: scroll; height:500px">
                                <img src="{{ asset('assets/user/img/shop-logo-8.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-14.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-9.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-4.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/Carlogo2.png') }}" alt="" class=""
                                    style="z-index: 10;height: 50px;width: 140px;margin: auto;">
                                <img src="{{ asset('assets/user/img/shop-logo-6.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-7.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-13.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-3.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-5.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-1.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-2.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-10.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-11.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-12.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-15.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-16.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-17.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-18.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-19.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-20.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-21.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-22.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-23.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-24.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                                <img src="{{ asset('assets/user/img/shop-logo-25.png') }}" alt=""
                                    class="h-25 w-auto" style="z-index: 10;">
                            </div>
                        </div>
                    </div>
...
<section class=" container">
    <div class="align-items-center row">
        <div class="col-lg-6">
            ...
            <p class="fs-6 fw-normal lh-sm text-justify"> Gargash Auto was founded by a team of highly experienced
                automotive professionals committed to offering Luxury Car Care services Dubai UAE that go beyond
                expectations. With a presence in both Dubai and Sharjah, we have established ourselves as a trusted name
                for car owners seeking premium service. Our mission is to provide a transparent and customer-friendly
                experience that addresses common frustrations found in other repair shops, ensuring every visit is a
                seamless one. </p>
            <p class="fs-6 fw-normal lh-sm"> We specialize in car care services Dubai, focusing on delivering expert
                maintenance and repairs for the finest German and European brands. From Mercedes to BMW, Audi to
                Porsche, our skilled technicians bring unmatched expertise to every service. At Gargash Auto, attention
                to detail and precision are our top priorities, and we take immense pride in offering tailored solutions
                for each vehicle. </p>
            <p class="fs-6 fw-normal lh-sm">Our commitment to quality service doesn’t stop there—we ensure that you
                receive the highest level of care at the most competitive prices, making exceptional Luxury Car Care
                services Dubai UAE accessible to all luxury vehicle owners. At Gargash Auto, your satisfaction is our
                top priority, and we are dedicated to keeping your car running smoothly for years to come.</p>
            <p class="fs-6 fw-normal lh-sm">For inquiries or suggestions, feel free to contact us anytime. </p>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-10">
                <div class="offers-wrapper">
                    ...
                    <p class="level-7 primary-light-font extra-color-5 col-lg-7 col-md-9">Get unbeatable deals and
                        premium car care services Dubai to keep your elite German and European vehicle in top condition.
                    </p>
    ...
    <div class="container">
        <div class="process-top-content text-center mb-5">
            <div class="ml14">
                ...
                <p class="level-7 primary-regular-font dark-color col-lg-9 mx-auto">Our expert Luxury Car Care services
                    Dubai UAE combine advanced tools, modern techniques, and skilled technicians. With our 4-step car
                    repair model, we ensure comfort, convenience, and premium care for every German and European car
                    owner.</p>
...
<!-- review-section Starts Here  --> @include('user.layouts.partials.google-review')
<!-- review-section Ends Here  -->
<!-- sticky-icons Section Start --> @include('user.layouts.partials.sticky-icons')
<!-- sticky-icons Section End -->
<!-- sticky-icons Section Start --> @include('user.layouts.partials.sticky-icons-mobile')
<!-- sticky-icons Section End -->
